...
// The base student experience: submit a report, then see your own reports.
// (The Dorm Head view reuses this and adds the cleaning schedule.)
export function StudentView({ myReports, onAddReport }: StudentViewProps) {
  return (
